...
results_df = pd.read_excel("9leadlist_with_language_column.xlsx")
...
nederlandse_leads_df.to_excel("10nederlandse_leads.xlsx", index=False)
...
overige_leads_df.to_excel("11engelse_leads.xlsx", index=False)
